...
<div class="textWyrownany">
	...
	Nasze realizacje:<img src="static/img/leftarrow.png" alt="poprzednie" class="inline" id="previousRealization"><span id="navigation"></span><img src="static/img/rightarrow.png" alt="kolejne realizacje" class="inline" id="nextRealization"><a href="/{$zone}/{$directory}/mapa" class="link" title="Geograficzne umiejscowienie realizacji">Mapa</a>
